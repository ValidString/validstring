...
var HasNot = function (_BaseValidation) {
  ...
  function HasNot() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = HasNot.__proto__ || Object.getPrototypeOf(HasNot)).call.apply(_ref, [this].concat(args))), _this), _this.errorMessage = '', _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(HasNot, [{
    ...
    value: function evaluate(text, options) {
      ...
      if (!this.errorMessage && !options.errorMessage) {
        this.errorMessage = '%s cannot contain any of the following characters: ' + options.chars;
      }
